...
## 0. 装备依赖 (Dependencies)
- **价值传递 (Must-Have)**:
  - `@00_System/Agent_Skills/Prototype_Interaction/Storyboard_Storytelling.md` (产品演示叙事)
  - `@00_System/Agent_Skills/Prototype_Interaction/Browser_Tracker.md` (自动化截图演示)
    `@00_System/Agent_Skills/Core_Documentation/Markdown_Standard.md` (用于撰写高管战报与图文手册)
