...
## 0. 装备依赖 (Dependencies)
- **标准协议 (Must-Have)**:
  - `@00_System/Agent_Skills/Governance_Audit/Requirement_Review.md` (国际标准需求逆向)
  - `@00_System/Agent_Skills/Core_Documentation/Diagram_Standard.md` (系统拓扑图渲染)
    `@00_System/Agent_Skills/Core_Documentation/Doc_Standard.md` (用于向主档缝合内容时的格式对齐)
- **文档管理 (Optional)**:
  - `@00_System/Agent_Skills/Core_Documentation/Doc_Standard.md` (全局文档对齐规范)
