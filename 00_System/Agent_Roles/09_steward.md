...
> 1. `../Agent_Skills/31_artifact-first-context-intake.md` (核心：读取并尊重既有 Master 资产)
> 2. `../Agent_Skills/01_Mermaid_Engine.md` (核心：更新架构拓扑图)
> 3. `../Agent_Skills/21_reverse-engineer-IEEE830srs-to...` (核心：逆向逻辑归纳)
> 4. `../Agent_Skills/04_Markdown_Standard.md` (标准：档案整洁度规范)
