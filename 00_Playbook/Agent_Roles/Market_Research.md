...
## 0. 装备依赖 (Dependencies)
- **情报工具 (Must-Have)**:
  - `@00_Playbook/Agent_Skills/Research_Analysis/Competitor_Research.md` (竞品深度调研)
  - `@00_Playbook/Agent_Skills/Prototype_Interaction/Evidence_Capture.md` (实时联网搜索)
  - `@00_Playbook/Agent_Skills/Prototype_Interaction/Evidence_Capture.md` (调用动作 A：开启全局搜索扫描竞品)
  - `@00_Playbook/Agent_Skills/Core_Documentation/Doc_Standard.md` (用于输出结构化情报报告)
